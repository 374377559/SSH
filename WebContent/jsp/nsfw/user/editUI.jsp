    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td>
                ...
                <img src="${basePath}upload/${user.headImg}" width="100" height="110"/>
                </s:if>
        ...
        <tr>
            ...
            <td><s:textfield name="user.account" id="account" /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
            	<s:checkboxlist name="userRoleIds" listKey="roleId" listValue="name" list="#roleList"></s:checkboxlist>
            </td>
        </tr>
        <tr>
