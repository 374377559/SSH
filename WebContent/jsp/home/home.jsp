...
<div class="menu">
    <ul class="clearfix">
        ...
        <li><a href="${ctx}/home_frame.action">纳税服务</a> </li>
                    ...
                    <td width="76" height="100" align="center" valign="middle">
                        <div class="left-tx">
                            <s:if test="%{#session.SYS_USER.headImg !=null && #session.SYS_USER.headImg !=''}">
                            	<img src="${ctx}/upload/<s:property value='#session.SYS_USER.headImg'/>" width="70" height="80" />
                            </s:if><s:else>
                            	<img src="${ctx}/images/home/gs09.png" width="70" height="80" />
                            </s:else>
